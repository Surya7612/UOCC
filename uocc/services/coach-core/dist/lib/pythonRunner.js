...
async function runPythonTests(source, tests, timeoutSec = 2) {
    ...
    const dir = (0, fs_1.mkdtempSync)((0, path_1.join)((0, os_1.tmpdir)(), "uocc-"));
    const userPath = (0, path_1.join)(dir, "user_code.py");
    const harnessPath = (0, path_1.join)(dir, "harness.py");
    (0, fs_1.writeFileSync)(userPath, source, "utf8");
...
if __name__ == "__main__":
    ...
    main()
`;
    (0, fs_1.writeFileSync)(harnessPath, harness, "utf8");
    const py = process.env.PYTHON || "python3";
    // -I = isolated, -B = no .pyc, -u = unbuffered stdio
    const child = (0, child_process_1.spawn)(py, ["-I", "-B", "-u", harnessPath, userPath], {
        cwd: dir,
    ...
    try {
        ...
        if (typeof json.passCount === "number" && Array.isArray(json.failures))
            return json;
    }
    catch (_) { }
    return {
